...
import 'package:thibaudbdx_app/feature/add_new_group/presentation/widget/custom_restaurant.dart';
          ...
          leading: Padding(
            ...
            child: GestureDetector(
              child: Transform.scale(
                  scale: 1, child: SvgPicture.asset(Assets.icons.arrowtir)),
            ),
          ),
          title:
              Text('Tags', style: TextFontStyle.headline24cFFFFFFpoppinsw700),
          centerTitle: true,
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFormFieldWidget(
                ...
                borderSide:
                    const BorderSide(color: AppColors.c848585, width: 1),
                contentPadding:
              ...
              CustomRestaurant(title: 'Restaurant',  image: SvgPicture.asset(Assets.icons.threedot),
              ),
            ],
          ),
        ),
