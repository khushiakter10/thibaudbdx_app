...
import 'package:thibaudbdx_app/feature/add_new_group/presentation/widget/color_custom.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextFormFieldWidget(
              ...
              borderSide:
              const BorderSide(color: AppColors.cE3E3E3, width: 1),
            ...
            CustomTextFormFieldWidget(
              ...
              suffixIcon: Transform.scale(
                scale: 0.90,
                child:
                Image.asset(Assets.images.profile.path, height: 24.h),
              ),
            ),
            UIHelper.verticalSpace(24.h),
            ...
            Center(
              child: Container(
                ...
                child: Text(
                  'Restaurant',
                  style: TextFontStyle.headline12cFFFFFFpoppinsw400.copyWith(fontSize: 16.sp),
                ),
              ),
            ),
